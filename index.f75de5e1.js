...
const outsideMenuElements = document.querySelectorAll("#page-logo, header .icon--phone, #open-menu-button, main .categories__button, main .category__link, main .form__name, main .form__email, main .form__message, main .contacts__button, main .information__phone-number a, main .information__email-name a, main .information__address-description a");
function openMenu() {
